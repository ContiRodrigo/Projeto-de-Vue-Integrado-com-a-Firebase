  ...
  <v-container fill-height fluid text-center>
    ...
    <v-dialog v-model="novaConta" persistent max-width="300">
      <v-card>
        ...
        <v-card-text>A conta não foi encontrada. Deseja criar uma nova com os dados informados?</v-card-text>
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="green darker-1" text @click="criarNovaConta">Sim</v-btn>
          <v-btn color="red darker-1" text @click="novaConta = false">Não</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
